...
# Crear aplicación
app = FastAPI(
    title="ScrapingWeb - Sistema de An├ílisis de Reseñas Hoteleras",
    description="Backend para an├ílisis de sostenibilidad y calidad de hoteles mediante scraping de reseñas",
    version="1.0.0",
    lifespan=lifespan
)
...
async def root():
    return {
        "app": "ScrapingWeb - Sistema de An├ílisis de Reseñas Hoteleras",
        "version": "1.0.0",
        "description": "API para an├ílisis de sostenibilidad y calidad hotelera"
    }
