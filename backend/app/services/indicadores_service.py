"""
Servicio de Indicadores - C├ílculo de mítricas y estadásticas
"""
...
class IndicadoresService:
    """Servicio de c├ílculo de indicadores y mítricas"""
    ...
    def calcular_indicadores_periodo(
        ...
        """Calcular indicadores de un hotel en un peráodo"""
        
        # Obtener reseñas del peráodo
        resenas = (
            db.query(Resena)
    ...
    def obtener_resenas_destacadas(
        ...
        """Obtener reseñas destacadas (├║ltima, m├ís positiva, m├ís negativa)"""
