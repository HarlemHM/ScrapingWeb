...
class ExportService:
    ...
    def generar_csv(
        ...
        with open(filepath, 'w', newline='', encoding='utf-8') as csvfile:
            ...
            # Header
            writer.writerow(["Reporte de An├ílisis de Reseñas Hoteleras"])
            ...
            writer.writerow(["DISTRIBUCI├ôN POR PLATAFORMA"])
    ...
    def generar_pdf(
        ...
        # Tátulo
        story.append(Paragraph("Sistema de An├ílisis de Reseñas Hoteleras", title_style))
        ...
        if destacadas.get("mas_positiva"):
            ...
            story.append(Paragraph("<b>Reseña M├ís Positiva:</b>", styles['Normal']))
            ...
            if destacadas.get("mas_negativa"):
                ...
                story.append(Paragraph("<b>Reseña M├ís Negativa:</b>", styles['Normal']))
