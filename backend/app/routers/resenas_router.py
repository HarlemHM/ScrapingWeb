...
def listar_resenas_hotel(
    ...
    Usado por el frontend para An├ílisis Cualitativo con filtros de fecha.
    """
...
def obtener_resenas_destacadas(
    ...
    """
    Obtener reseñas destacadas (├║ltimas, m├ís positivas, m├ís negativas).
    Usado para An├ílisis Cualitativo.
    """
