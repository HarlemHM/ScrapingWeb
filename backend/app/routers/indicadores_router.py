"""
Router de Indicadores - An├ílisis Cuantitativo y Visualización Comparativa
"""
...
def obtener_resumen_global(
    ...
    sostenibilidad_min: Optional[float] = Query(None, ge=1, le=5, description="Sostenibilidad mánima"),
    calidad_min: Optional[float] = Query(None, ge=1, le=5, description="Calidad mánima"),
    db: Session = Depends(get_db)
):
    """
    Obtener resumen global de todos los hoteles.
    Usado para los 4 cards principales del An├ílisis Cuantitativo:
    - Total Hoteles
    ...
    # (esto filtraráa los hoteles que cumplen los criterios mánimos)
...
def obtener_tabla_hoteles(
    ...
    Usado para la tabla principal del An├ílisis Cuantitativo con:
...
def obtener_distribucion_plataformas(
    ...
    Usado para el gr├ífico de barras en Visualización Comparativa.
    """
...
def obtener_distribucion_sentimientos(
    ...
    Usado para el gr├ífico de barras horizontales en Visualización Comparativa.
    """
    from app.models.resena import Resena
    from app.models.sentimiento import Sentimiento
    from sqlalchemy import func, and_
...
def obtener_comparacion_hoteles(
    ...
    Usado para el gr├ífico de barras agrupadas en Visualización Comparativa.
    """
    from app.models.hotel import Hotel
    from app.models.resena import Resena
    from app.models.hotel_plataforma import HotelPlataforma
...
def obtener_resumen_hotel(
    ...
    """Obtener resumen de indicadores de un hotel especáfico"""
