...
def iniciar_scraping_simulado(
    ...
    se ejecuta autom├íticamente una vez al dáa mediante worker.
    """
    return ScrapingResponse(
        job_id="simulated-scraping-frontend",
        message="El scraping se ejecuta autom├íticamente cada dáa. Revisa los datos actualizados."
    )
...
def obtener_estado_scraping():
    ...
    return ResponseBase(
        success=True,
        message="Sistema de scraping operativo. Ejecución autom├ítica programada diariamente."
    )
